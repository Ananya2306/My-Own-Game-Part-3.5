...
e3 = createSprite(605,57,0.5,0.5);
e3.addImage(en2);
e3.scale = 0.24;

e4 = createSprite(990,97,0.5,0.5);
e4.addImage(en1);
e4.scale = 0.24;

e5 = createSprite(1255,67,0.5,0.5);
e5.addImage(en1);
e5.scale = 0.24;

e6 = createSprite(1130,227,0.5,0.5);
e6.addImage(en2);
e6.scale = 0.24;

e7 = createSprite(1140,407,0.5,0.5);
e7.addImage(en1);
e7.scale = 0.24;

e8 = createSprite(1255,517,0.5,0.5);
e8.addImage(en2);
e8.scale = 0.24;

e9 = createSprite(725,332,0.5,0.5);
e9.addImage(en1);
e9.scale = 0.24;

e10 = createSprite(510,222,0.5,0.5);
e10.addImage(en2);
e10.scale = 0.24;

e11 = createSprite(190,222,0.5,0.5);
e11.addImage(en1);
e11.scale = 0.24;

e12 = createSprite(225,142,0.5,0.5);
e12.addImage(en2);
e12.scale = 0.24;
